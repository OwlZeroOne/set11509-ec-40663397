...
class CTkDatePicker(ctk.CTkFrame):
    def __init__(self, master=None, **kwargs):
        ...
        # EDIT: Changed %m/%d/%Y to %Y-%m-%d to match yfinance output date format
    ...
    # EDIT: Add this method to enable setting default values, or forcing values into Entry fields.
    ...
    def open_calendar(self):
        ...
        # EDIT: Following line added to fix appearance of the calendar window behind the main Window.
